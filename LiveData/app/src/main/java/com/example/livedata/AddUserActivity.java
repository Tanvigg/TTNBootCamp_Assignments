...
public class AddUserActivity extends AppCompatActivity {
    public static final String EXTRA_ID = "com.example.livedata.EXTRA_ID";
    public static final String EXTRA_NAME = "com.example.livedata.EXTRA_NAME";
    public static final String EXTRA_EMAIL = "com.example.livedata.EXTRA_EMAIL";
    public static final String EXTRA_PHONE = "com.example.livedata.EXTRA_PHONE";
